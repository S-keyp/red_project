 ...
 */
final class Version20220120134742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pro_bundles (id INT AUTO_INCREMENT NOT NULL, title_service VARCHAR(255) NOT NULL, description_service VARCHAR(255) NOT NULL, image_service INT NOT NULL, professionnal INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
